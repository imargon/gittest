...
select 
     ...
     "PROGRAM_ID"
      -- "LAST_ACTIVE_TIME"   
  from v$sql t1
 where to_char(to_timestamp(FIRST_LOAD_TIME, 'yyyy-mm-dd hh24:mi:ss'),'yyyymmdd') >= 20160523
   and to_char(to_timestamp(FIRST_LOAD_TIME, 'yyyy-mm-dd hh24:mi:ss'),'yyyymmdd') <= 20160526
